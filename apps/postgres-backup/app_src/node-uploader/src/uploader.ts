...
export class Uploader {
  ...
  constructor(
    ...
    let S3Configuration: S3ClientConfig = {
      ...
      forcePathStyle: true,
      endpoint: storageConfig.BUCKET_ENDPOINT
        ? storageConfig.BUCKET_ENDPOINT
        : "",
    };
      ...
      this.client
        ...
        .then(() => {
          ...
          fs.unlink(path, function (err) {
            ...
            console.log("file deleted from local disk successfully");
          });
        })
        .catch((err) => {
